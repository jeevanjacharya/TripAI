...
#     else:
#         code = matches[0]
#         corrected_code = code.replace("data", "df")  # Ensure correct variable reference
...
def chat_with_data_api(df, model="gpt-4", temperature=0.0, max_tokens=256, top_p=0.5):
    ...
    if "plot" in st.session_state.messages[-1]["content"].lower():
        ...
        pandas_df_agent = create_pandas_dataframe_agent(
            ...
            allow_dangerous_code=True  # Add this flag to enable code execution
        )
